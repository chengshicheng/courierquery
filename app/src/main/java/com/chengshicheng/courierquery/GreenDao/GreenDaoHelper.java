...
import com.chengshicheng.greendao.gen.DaoMaster;
import com.chengshicheng.greendao.gen.DaoSession;
...
public class GreenDaoHelper {
    ...
    public static void initDatabase() {
        ...
        mHelper = new DaoMaster.DevOpenHelper(CourierApp.getContext(), "cache-db", null);
